...
$(document).ready(function(){
	...
	// EVENT LISTENER FOR SUPERSTAR ELEMENT
 	$("superstar").on(
	{
		mouseenter: function(){
		...
		mouseleave: function(){
			...
			$("superstar").popover("destroy");
		}
	});

 	// EVENT LISTENER FOR DIVA ELEMENT
	$("diva").on(
	{
		mouseenter: function(){
	...
	$.fn.lookup = function(searchFor,type,scope)
	{
		$.ajax({
			...
			success: function(data,status,jqXHR) {
				...
				if(responseCode == 200)
					$.fn.loadContent(data.Response,scope, false);
				else
					$.fn.loadContent(data.Response,scope, true);
			}
		});
	}

	$.fn.loadContent = function(response, scope, isNotFound)
	{
		...
		{	
			...
			"data-content": (!isNotFound) ? $.fn.getContent(response) : $.fn.getNotFoundContent(response)
		}
	...
	$.fn.getNotFoundContent = function(response)
	{
		var html = "";
		html += "This superstar or diva was not found. ";
		html += "Please visit <a href='http://www.wwe.com'>http://www.wwe.com</a>";
	}
	...
	$.fn.getContent = function(response)
	{
		...
		html += "<table class='popover-custom'>";
		html += "<tbody>";
		html += "<tr>";
		...
		html += "</tr>";
		html += "<tr>"
		html += "<td colspan=2 class='popover-custom-image-col'><img src='" + response._image + "'/></td>";
		html += "</tr>";
		html += "</tbody>";
		html += "</table>";
